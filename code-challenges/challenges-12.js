...
const cvsFiltration = (arr) => {
    ...
    const nameChecker = (firstName, lastName) => {
      ...
      let filtered = arr.filter(
        (ele) => ele.yearsOfExperience > 4 && ele.tech == "JS"
      );
      let filtered2 = filtered.map((ele) => {
        return {
          fullName: nameChecker(ele.firstName, ele.LastName),
          tech: ele.tech,
        };
      });
      return filtered2;
...
const vowelsFiltration = (arr) => {
    // write your code here
    return arr.filter((ele) => !/[aeiou]/.test(ele));
} 
// -------------------------------------------------------------------------------------------------------
