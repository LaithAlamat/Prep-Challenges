...
const LastWord = (str) => {
    ...
    let lastWordInStr = str.slice(str.lastIndexOf(" ") + 1, str.length);
...
const LastWord_2 = (str) => {
    // write your code here
    let arr = str.split(" ");
    let lastWordInStr = arr.slice(arr.length - 1, arr.length);
    return lastWordInStr.join();
}
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
    // write your code here
    let replaced = str.split(" ");
  replaced.forEach((ele, index) => {
    if (ele == "I") {
      replaced.splice(index, 1, "We");
    } else if (ele == "am") {
      replaced.splice(index, 1, "are");
    } else if (ele == "was") {
      replaced.splice(index, 1, "were");
    }
  });
